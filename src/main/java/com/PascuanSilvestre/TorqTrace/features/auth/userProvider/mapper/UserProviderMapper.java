...
import com.PascuanSilvestre.TorqTrace.features.auth.userProvider.dto.UserProviderRequestDTO;
...
public class UserProviderMapper implements IMapper<UserProviderEntity, UserProviderRequestDTO, UserProviderResponseDTO> {

    private final ModelMapper modelMapper;
    @Override
    public UserProviderEntity toEntity(UserProviderRequestDTO request) {
